...
@section('content')
    ...
    <div class="card mt-3">
        ...
        <div class="card-body">
            <h5 class="card-title">Cadastrar Postagem do BLog</h5>
        </div>
            ...
            <form action="{{ route('blog-store') }}" method="POST" enctype="multipart/form-data" id="form">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select select2" name="tipo_postagem_id" id="tipo_postagem_id" required>
                            ...
                            @foreach ($tipoPostagens as $tipoPostagem)
                                <option value="{{ $tipoPostagem->id }}">{{ $tipoPostagem->tipo_postagem }}</option>
                            @endforeach
                        </select>
                    </div>
                    <!-- Categoria -->
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" id="data_publicacao" name="data_publicacao" value="{{ old('data_publicacao') }}" required>
                    </div>
                </div>
                <div class="row mb-3">
                    <!-- Fonte -->
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="fonte" name="fonte" value="{{ old('fonte') }}" required>
                    </div>
                    <!-- Ativo -->
