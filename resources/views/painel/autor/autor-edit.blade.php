...
@section('content')
    ...
    <div class="card mt-3">
        ...
        <div class="mb-3 ms-3 me-3">
            <form action="{{ route('autor-update' , ['autor' => $autor->id]) }}" method="POST" enctype="multipart/form-data"  id="form-autor">
                @csrf()
                <div class="row mb-3">
                    <input type="hidden" class="form-control" id="id" name="id" value="{{ $autor->id }}" required>
                    <!-- Título -->
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="email" name="email" value="{{ $autor->email }}" required>
                    </div>
                </div>
                <div class="row mb-3">
                    <!-- Foto -->
                    ...
                    <div class="col-md-2">
                        <img src="{{ asset('storage/' . $autor->foto) }}" alt="Imagem" style="width: 150px; height: 80px;">
                    </div>
                    <!-- Ativo -->
...
<script>
    ...
    @if(isset($autor->perfil))
            quill.root.innerHTML = "{!! addslashes($autor->perfil) !!}";
    @endif
